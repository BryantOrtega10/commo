...
@section('content_header')
    <div class="row">
        ...
        <div class="text-right col-md-3">
            <a href="{{ route('commissions.agent-process.show-email') }}" class="btn btn-outline-primary edit-email-template">Email Statements</a>
        </div>
    </div>
@stop
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('statement_date') is-invalid @enderror"
                                id="statement_date" name="statement_date" required value="{{ old('statement_date') }}" required>
