                        ...
                        <tbody>
                            ...
                            @foreach ($agentNumberItem['statements_items'] as $itemStatement)
                                ...
                                <tr>
                                    ...
                                    <td>{{ date('m/d/Y', strtotime($policy->original_effective_date)) }}</td>
                                    <td>{{ date('m/d/Y', strtotime($itemStatement->commission_transaction->accounting_date)) }}
                                    </td>
                                    <td>{{ date('m/d/Y', strtotime($policy->cancel_date)) }}</td>
