...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('supervisor.leads.details', ['id' => $lead->id]) }}">Details</a></li>
...
@section('content')
    ...
    @endif
    <div class="card">
        <form action="{{ route('supervisor.leads.update', ['id' => $lead->id]) }}" method="post">
            @csrf
            <div class="card-body">
                <div class="row">
