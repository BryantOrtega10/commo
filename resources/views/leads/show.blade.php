...
@section('content_header')
    <div class="row">
        ...
        <div class="text-right col-md-3">
            <a href="{{ route('leads.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                Create Lead</a>
        </div>
    </div>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <table class="table table-striped datatable min-w-100" data-url="{{ route('leads.datatable') }}">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Email</th>
